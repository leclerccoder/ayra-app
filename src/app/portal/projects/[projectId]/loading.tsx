        ...
        <div className="flex flex-col items-center justify-center min-h-[500px] py-16">
            <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center">
                    <p className="text-xl font-medium text-foreground">Loading Project Details...</p>
                    <p className="text-base text-muted-foreground mt-2">Please wait while we fetch your project</p>
                </div>
            </div>
        </div>
    );
